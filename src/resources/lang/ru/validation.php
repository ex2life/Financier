...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'date_registr' => [
            'before_or_equal' => 'Дата регистрации не может быть позднее текущей',
        ],
        'date_begin_work' => [
            'after' => 'Дата начала деятельности не может быть раннее, чем дата регистрации',
            'before_or_equal' => 'Дата начала деятельности не может быть позднее текущей',
        ],
        'inn' => [
            'regex' => 'Инн состоит только из цифр',
        ],
        'edit_date_registr' => [
            'before_or_equal' => 'Дата регистрации не может быть позднее текущей',
        ],
        'edit_date_begin_work' => [
            'after' => 'Дата начала деятельности не может быть раннее, чем дата регистрации',
            'before_or_equal' => 'Дата начала деятельности не может быть позднее текущей',
        ],
        'edit_inn' => [
    ...
    */
    ...
    'attributes' => [
        'name'                  => 'Фио',
        'edit_name_company'     => 'Название компании',
        'edit_inn'              => 'Инн',
        'edit_opf'              => 'Организационно-правовая форма',
        'edit_sno'              => 'Система налогооблажения',
        'date_calc_limit'       => 'Дата расчета',
        'name_company'          => 'Название компании',
        'inn'                   => 'Инн',
        'sum'                   => 'Сумма кредита',
        'month'                 => 'Срок кредита',
        'stavka'                => 'Ставка кредита',
        ...
        'available'             => 'Доступно',
        'size'                  => 'Размер',
        'brief_name'            => 'Краткое имя',
        'full_name'             => 'Полное имя',
        'edit_brief_name'            => 'Краткое имя',
        'edit_full_name'             => 'Полное имя',
    ],
];
