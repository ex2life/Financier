</div><div id="newCompany" class="modal @if(session('modalNew')) show @endif" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document" data-show="true">
        <div class="modal-content">
            <form method="post" action="{{route('company_add', ['id' => $gsz->id]) }}">
                @csrf
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">Создать компанию
                    </button>
                </div>
            </form>
        </div>
