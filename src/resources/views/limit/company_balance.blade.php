                                        ...
                                        <form method="post" action="{{route('save_balance', ['id' => $balance_date->id])}}">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                if( isset( $balance_date)) $sum_part_balance=$balance_date->get_Balance_Active_Sum();
                                                        ...
                                                        <th scope="col" class="text-right">
                                                            <strong id="pa{{$balance_date->id}}rt1">{{$sum_part_balance->value}}</strong></th>
                                                    </tr>
                                                    </tfoot>
                                                </table>
                                                <table class="table table-striped table-sm">
                                                ...
                                                if( isset( $balance_date)) $sum_part_balance=$balance_date->get_Balance_Passiv_Sum();
                                                        ...
                                                        <th scope="col" class="text-right">
                                                            <strong id="pa{{$balance_date->id}}rt0">{{$sum_part_balance->value}}</strong></th>
                                                    </tr>
                                                    </tfoot>
                                                </table>
                                            </div>
                                            <div class="row">
                                                <div class="col-12 col-md-6">
                                                    <div class="alert alert-success" id="pa{{$balance_date->id}}rt">Все хорошо, пассив равен активу.</div>
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <button id="but{{$balance_date->id}}" class="btn btn-primary w-100" type="submit">
                                                        Сохранить
                                                    </button>
                                                </div>
                                            </div>
