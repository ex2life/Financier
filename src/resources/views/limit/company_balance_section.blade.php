...
<tr>
    ...
    <th scope="col" class="text-right">
        <strong class="pa{{$balance_date->id}}rt{{$child_section->balance_article->balance_part}}" id="sec{{$balance_date->id}}tion{{$child_section->balance_article->section_code}}">{{$sum_section->value}}</strong></th>
</tr>
</tbody>
